        ...
        <>
            <div className="overflow-x-hidden">
                ...
                <main className="content">
                    <BreadcrumbItem link="Our Services" img="/images/banner/about1.png" title="Nos services" desc="Découvrez notre large gamme de services conçus pour accompagner les entreprises dans leur transformation numérique. Nous offrons des solutions adaptées à chaque besoin, allant de l’élaboration de stratégies de transformation à l'intégration de technologies avancées. Quel que soit votre secteur, nos experts sont là pour vous aider à naviguer dans le monde numérique et à améliorer votre performance organisationnelle." />
                            ...
                            <div className="flex max-xl:flex-col gap-y-8">
                                <div className="col-12 xl:w-3/4">
                                    <div className="content-para xl:pr-[80px]">
                                        <div className="heading3">Toute entreprise a besoin d'un accompagnement</div>
                                        <div className="body2 text-secondary mt-4">Nous comprenons que chaque entreprise traverse des défis uniques dans sa quête de transformation numérique. Que vous soyez une petite entreprise cherchant à automatiser vos processus ou une grande organisation ayant besoin de moderniser ses systèmes, nous mettons à votre disposition des outils sur mesure et des conseils experts. Notre objectif est de vous offrir les solutions nécessaires pour faire face aux enjeux du numérique, tout en vous permettant d’optimiser vos ressources et d'améliorer vos résultats à long terme.</div>
                                        ...
                                        <div className="heading6">Nous proposons diverses solutions</div>
                                            ...
                                            <div className="flex max-lg:flex-col gap-y-3">
                                                <div className="w-full lg:w-1/2 gap-y-3 flex flex-col">
                                                    <div className="item flex items-center gap-4"> <Icon.CheckCircle weight="fill" className="text-xl text-blue flex-shrink-0" />
                                                        <div className="text-button">Transformation numérique</div>
                                                    </div>
                                                    <div className="item flex items-center gap-4"> <Icon.CheckCircle weight="fill" className="text-xl text-blue flex-shrink-0" />
                                                        <div className="text-button">Gouvernance du Numérique</div>
                                                    </div>
                                                    <div className="item flex items-center gap-4"> <Icon.CheckCircle weight="fill" className="text-xl text-blue flex-shrink-0" />
                                                        <div className="text-button">Conseil Stratégique</div>
                                                    </div>
                                                    <div className="item flex items-center gap-4"> <Icon.CheckCircle weight="fill" className="text-xl text-blue flex-shrink-0" />
                                                        <div className="text-button">Développement de Solutions</div>
                                                    </div>
                                                </div>
                                                <div className="w-full lg:w-1/2 gap-y-3 flex flex-col">
                                                    <div className="item flex items-center gap-4"> <Icon.CheckCircle weight="fill" className="text-xl text-blue flex-shrink-0" />
                                                        <div className="text-button">Gouvernance des Données</div>
                                                    </div>
                                                    <div className="item flex items-center gap-4"> <Icon.CheckCircle weight="fill" className="text-xl text-blue flex-shrink-0" />
                                                        <div className="text-button">Intelligence Artificielle</div>
                                                    </div>
                                                    <div className="item flex items-center gap-4"> <Icon.CheckCircle weight="fill" className="text-xl text-blue flex-shrink-0" />
                                ...
                                <div className="w-full xl:w-1/4">
                                    <div className="more-infor border border-line rounded-xl py-8 px-6">
                                        ...
                                        <div className="body3 text-secondary mt-2">Que vous ayez une équipe de 10 ou 100 personnes, nous avons la solution pour vous, et vous aurez toujours des services de qualité.</div>
                                        <div className="list-nav mt-4">
                                            ...
                                            >
                                                <div className="text-button text-secondary">
                                                Cybersécurité</div><i className="ph-bold ph-caret-right hidden"></i></Link></div>
                                    </div>
                                    <div className="ads-block rounded-lg md:mt-10 mt-6 relative">
                                        ...
                                        <div className="text flex flex-col justify-between absolute left-0 top-0 w-full h-full p-8">
                                            <div className="title">
                                                ...
                                                <div className="body3 text-white mt-4">Si vous avez un projet,<br />contactez-nous!</div>
                                            </div>
                                            <div className="button-block md:mt-10 mt-6"> <a className="button-main hover:bg-black hover:text-white inline-block bg-white text-button" href="contact-style-one.html">Consultez!</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
