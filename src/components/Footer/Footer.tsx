        ...
        <div className="container">
          <div className="flex max-lg:flex-col max-lg:items-start gap-y-10 pb-10">
            <div className="lg:w-1/4">
              <div className="footer-company-infor flex flex-col justify-between gap-5">
                ...
                <div className="text caption1 text-white">
                  Nous sommes une entreprise diversifiée spécialisée dans la
                  fourniture de solutions financières et numériques complètes
            ...
            <div className="lg:w-1/2">
              <div className="footer-navigate flex items-start justify-center gap-20">
                ...
                <div className="footer-nav-item">
                  ...
                  <ul className="list-nav mt-1">
                    ...
                    <li className="mt-3">
                      <Link
                        className="caption1 has-line-before line-white text-surface hover-underline"
                        href="/audit-maturite-digitale"
                      >
                        Etat Gouvernance Numérique
                      </Link>
                    </li>
                    <li className="mt-3">
                      <Link
                        className="caption1 has-line-before line-white text-surface hover-underline"
                        href="/audit-securite-digitale"
                      >
                    ...
                    <li className="mt-3">
                      <Link
                        className="caption1 has-line-before line-white text-surface hover-underline"
                        href="/agent-commercial-intelligent"
                      >
                        Agent commercial intelligent
                      </Link>
                    </li>
                  </ul>
                </div>
            ...
            <div className="lg:w-1/4">
              <div className="company-contact">
                ...
                <div className="button-block mt-5 ml-10">
          ...
          <div className="footer-bottom flex items-center justify-between pt-3 pb-3">
            <div className="left-block flex items-center">
              <div className="copy-right text-surface caption1">
                ©2025 Hamilcar. Tous droits réservés.
              </div>
            </div>
            <div className="nav-link flex items-center gap-2.5">
              ...
              {/* <span className="text-surface caption1">|</span>
                            Cookie Policy
                            <a className="text-surface caption1 hover-underline" href="#!">Politique relative aux cookies</a> */}
            </div>
          </div>
        </div>
      </div>
